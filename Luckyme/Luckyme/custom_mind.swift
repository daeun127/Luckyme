...
var thinks: [String] = ["럭키걸 사고", "마이웨이 사고", "해탈적 사고", "월급쟁이 사고"]
var img: [String] = ["iv-01", "iv-02", "iv-03", "iv-04"]
...
struct thinkView: View {
    ...
    var body: some View {
        ...
        NavigationLink(destination: custom_mind_info(think: think, desc: descs[i])){
            ZStack{
                VStack(spacing: 9){
                    if i < img.count {
                        Image(img[i])
